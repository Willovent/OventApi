   ...
   public partial class Input
   {
        ...
        public async Task<string> Down()
        {
            return await _client.GetData<string>("Input.Down",null);
                ...
                /// <returns>string</returns>
        public async Task<string> ExecuteAction(KodiRpc.Input.Action? action=null)
        {
        ...
        public async Task<string> ShowOSD()
        {
            return await _client.GetData<string>("Input.ShowOSD",null);
                ...
                /// </summary>
                /// <returns>string</returns>
        public async Task<string> ShowPlayerProcessInfo()
        {
            return await _client.GetData<string>("Input.ShowPlayerProcessInfo",null);
        }
        ...
        public delegate void OnInputRequestedDelegate(string sender=null, KodiRpc.Input.OnInputRequested_data data=null);
        public event OnInputRequestedDelegate OnInputRequested;
        internal void RaiseOnInputRequested(string sender=null, KodiRpc.Input.OnInputRequested_data data=null)
        {
