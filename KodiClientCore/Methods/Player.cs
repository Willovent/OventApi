   ...
   public partial class Player
   {
        ...
        public async Task<string> SetSubtitle(int? playerid=null, bool? enable=null)
        {
            ...
            return await _client.GetData<string>("Player.SetSubtitle", jArgs);
                ...
                /// <param name="stream"> REQUIRED </param>
                /// <returns>string</returns>
        public async Task<string> SetVideoStream(int? playerid=null, KodiRpc.Player.SetVideoStream_stream1? stream=null)
        {
             var jArgs = new JObject();
            ...
            return await _client.GetData<string>("Player.SetVideoStream", jArgs);
        }
                ...
                /// <param name="stream"> REQUIRED </param>
                /// <returns>string</returns>
        public async Task<string> SetVideoStream(int? playerid=null, int? stream=null)
        {
             var jArgs = new JObject();
            ...
            return await _client.GetData<string>("Player.SetVideoStream", jArgs);
                ...
                /// <param name="playerid"> REQUIRED </param>
                /// <returns>string</returns>
        public async Task<string> SetVideoStream(int? playerid=null)
        {
             var jArgs = new JObject();
