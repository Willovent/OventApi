   ...
   public partial class Application
   {
        private readonly Client _client;
          public Application(Client client)
          {
              _client = client;
                ...
                /// <returns>KodiRpc.Application.Property.Value</returns>
        public async Task<KodiRpc.Application.Property.Value> GetProperties(KodiRpc.Application.GetProperties_properties properties=null)
        {
            ...
            return await _client.GetData<KodiRpc.Application.Property.Value>("Application.GetProperties", jArgs);
        }
        ...
        public async Task<bool> SetMute(bool? mute=null)
        {
            ...
            return await _client.GetData<bool>("Application.SetMute", jArgs);
                ...
                /// <param name="mute"> REQUIRED </param>
                /// <returns>bool</returns>
        public async Task<bool> SetMute(KodiRpc.Global.Toggle2? mute=null)
        {
             var jArgs = new JObject();
        ...
        public async Task<int> SetVolume(int? volume=null)
        {
            ...
            return await _client.GetData<int>("Application.SetVolume", jArgs);
                ...
                /// <param name="volume"> REQUIRED </param>
                /// <returns>int</returns>
        public async Task<int> SetVolume(KodiRpc.Global.IncrementDecrement? volume=null)
        {
             var jArgs = new JObject();
        ...
        public delegate void OnVolumeChangedDelegate(string sender=null, KodiRpc.Application.OnVolumeChanged_data data=null);
